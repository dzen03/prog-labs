...
{
    static final String DB_LOGIN = "vgelcktarjmszf";
    static final String DB_PASS = "7d232e93ac6abee26b0b665e32c637d35dadd609c740fac42a3d9e925ddf6219";
    static final String DB_URL = "jdbc:postgresql://ec2-63-34-180-86.eu-west-1.compute.amazonaws.com:5432/db9dabgv1fecp8";
    ...
    {
        LOGGER.log(Level.INFO, String.format("UPDATE cities SET(city_id, area, car_code, name, meters_above_sea, " +
    ...
    public static int auth(String login, String pass) throws AuthException, SQLException
    {
        ...
        while (true)
        {
            try
            {
                resultSet = statement.executeQuery("SELECT user_id, pass_hash  FROM users WHERE login = '" + login + "'");
                break;
            }
            catch (Exception ex)
            {
