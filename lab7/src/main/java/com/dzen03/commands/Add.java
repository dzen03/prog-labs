...
public class Add extends Command
{
    ...
    public String[] preExecute(String[] args)
    {
        ...
        while (true)
        {
            System.out.println(NAME_COLOUR + "Government (ARISTOCRACY/DICTATORSHIP/MATRIARCHY/MONARCHY/PLUTOCRACY): " + INPUT_COLOUR);
            try
            {
        ...
        while (true)
        {
            System.out.println(NAME_COLOUR + "Standard of living (MEDIUM/ULTRA_LOW/NIGHTMARE): " + INPUT_COLOUR);
            try
            {
